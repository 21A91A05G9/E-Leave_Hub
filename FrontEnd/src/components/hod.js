...
export default function Hod() {
    ...
    useEffect(() => {
        const fetchHodDetails = async () => {
            try {
                const hodResponse = await axios.post(`http://localhost:5001/findhod/${id}`);
        ...
        const fetchCounts = async () => {
            try {
                ...
                //     axios.post(`http://localhost:5001/countupdate1/${id}`),
                //     axios.post(`http://localhost:5001/countupdate0/${id}`),
                //     axios.post(`http://localhost:5001/countupdate-1/${id}`)
                // ]);
                seta(0);
                setr(0);
                seto(0);
