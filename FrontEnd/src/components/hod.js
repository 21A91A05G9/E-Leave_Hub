...
export default function Hod() {
    ...
    useEffect(() => {
        const fetchHodDetails = async () => {
            try {
                const hodResponse = await axios.post(`https://e-leave-hub-backend.vercel.app/findhod/${id}`);
        ...
        const fetchCounts = async () => {
            try {
                ...
                //     axios.post(`https://e-leave-hub-backend.vercel.app/countupdate1/${id}`),
                //     axios.post(`https://e-leave-hub-backend.vercel.app/countupdate0/${id}`),
                //     axios.post(`https://e-leave-hub-backend.vercel.app/countupdate-1/${id}`)
                // ]);
                seta(0);
                setr(0);
                seto(0);
