    ...
    <div className="container about ">
      ...
      <div className="row">
          <div className="col-sm-12 col-xs-12 col-md-5 col-lg-5 col-xl-5 txt">
           ...
           <Link to='/studentlogin' className="col-md-4 mt-2"><button className="btn btn-success ">Student Login</button></Link>
           <Link to='/hodlogin' className="col-md-8 mt-2"><button className="btn btn-success">HOD Login</button></Link>
          </div>      
          
          </div>
          <div className="col-sm-12 col-xs-12 col-md-7 col-lg-7 col-xl-7"><img className="mainimg" src={logo} alt="logo"/></div>
      </div>
      ...
      <div className="row">
          <div className="col-sm-12 col-xs-12 col-md-5 col-lg-5 col-xl-5 txt">
            ...
            <div className="row"> <img className="mainimg" src={accept} alt="accept"/></div>
        ...
        <div className="row">
        <div className="col-sm-12 col-xs-12 col-md-7 col-lg-7 col-xl-7"><img className="mainimg" src={leave} alt="leave"/></div>
          <div className="col-sm-12 col-xs-12 col-md-5 col-lg-5 col-xl-5 txt">
